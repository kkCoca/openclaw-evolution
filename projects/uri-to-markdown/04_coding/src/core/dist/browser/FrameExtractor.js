export class FrameExtractor {
     ...
     * 提取有内容的 iframe
     */
    async extractContentFrames(page) {
     ...
     * 获取有内容的 frame 数量
     */
    getContentFrameCount(frames) {
        return frames.filter(f => f.hasContent).length;
    }
}
//# sourceMappingURL=FrameExtractor.js.map