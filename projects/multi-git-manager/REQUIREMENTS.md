...
- **优先级**: P0
- **描述**: 配置默认 push/pull 仓库
- **验收标准**: 在 `.multi-git/config.json` 中设置 primary 字段

### **[REQ-002]** 附属仓库配置

- **优先级**: P0
- **描述**: 配置多个镜像仓库
- **验收标准**: 支持配置多个 mirrors 数组项

### **[REQ-003]** 自动同步

- **优先级**: P0
- **描述**: 提交后自动推送到附属仓库
- **验收标准**: post-commit Hook 自动触发
...
- **优先级**: P1
- **描述**: 选择同步哪些分支
- **验收标准**: config.json 中配置 branches 数组
