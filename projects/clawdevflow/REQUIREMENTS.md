...
|---------|------|------|--------|------|---------|---------|
| REQ-001 | v1.0.0 | 原始需求 | - | ✅ 已完成 | 待映射 | 待映射 |
| REQ-002 | v1.1.0 | 增量需求 | REQ-001 | ✅ 已完成 | 待映射 | 待映射 |
...
| REQ-008 | v3.1.2 | Bugfix | REQ-007 | ⏳ 进行中 | 待映射 | 待映射 |
| REQ-009 | v3.1.3 | 增量需求 | REQ-003 | ⏳ 进行中 | 待映射 | 待映射 |

**覆盖率**: 0/9 = 0%（需要 PRD/TRD 完成后更新）
